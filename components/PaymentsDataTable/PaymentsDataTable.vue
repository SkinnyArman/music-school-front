      ...
      <div class="min-w-full py-2 align-middle">
        ...
        >
          ...
          >
            ...
            >
              <tr v-for="student in props.transactions" :key="student.id">
                <td
                ...
                <td
                  class="px-4 py-4 flex justify-center items-center text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap text-center"
                >
                  {{ student.student.name + " " + student.student.surname }}
                </td>
                <td class="text-center text-sm text-gray-500 whitespace-nowrap">
                  {{ student.amount }} تومان
                </td>
              </tr>
            </tbody>
          </table>
...
const props = defineProps(["transactions", "currentPage", "totalPages"]);
